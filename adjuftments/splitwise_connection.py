...
from adjuftments.schema import SplitwiseTable
...
class Splitwise(SplitwiseConn):
    ...
    def _find_financial_partner(self) -> Friend:
        """
        Retrieve your financial partner as a friend.
    ...
    def _get_transaction_balance(self, expense: Expense) -> Optional[float]:
        """
    ...
    def process_expense(self, expense: Expense) -> Optional[dict]:
        """
    ...
    def _comment_on_expense(self, expense_id: int) -> Tuple[object, object]:
        """
